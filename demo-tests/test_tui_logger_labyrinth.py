...
# from pytest_tui.tui_logger import get_tui_loggers

# logger = getLogger(__name__)

# title_logger, content_begin_logger, content_logger, content_end_logger = get_tui_loggers()

# # title_logger = getLogger("TitleLogger")
# # content_begin_logger = getLogger("ContentBeginLogger")
# # content_logger = getLogger("ContentLogger")
# # content_end_logger = getLogger("ContentEndLogger")
# # while(1):
