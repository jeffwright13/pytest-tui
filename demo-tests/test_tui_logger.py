...
def test_tui_logger_pass():
    logger = logging.getLogger("StandardPythonLogger")
    ...
    title_logger.warning(msg="Big-Ass-Lorem-Pass")
    content_logger.warning(f'{lorem()}')
    assert True
...
def test_tui_logger_fail():
    ...
    title_logger.warning(msg="Big-Ass-Lorem-Fail")
    content_logger.warning(f'{lorem()}')
    assert False

# @pytest.mark.flaky(reruns=2, reruns_delay=1)
# def test_tui_logger_flaky():
#     logger = logging.getLogger("StandardPythonLogger")
#     title_logger = TitleLogger("TitleLogger")
#     content_begin_logger = ContentBeginLogger("ContentBeginLogger")
#     content_end_logger = ContentEndLogger("ContentEndLogger")
...
#     title_logger.warning(msg="Title")
#     content_begin_logger.warning("ContentStart")
#     logger.warning(f'{lorem()}')
#     content_end_logger.warning("ContentEnd")
#     assert pass_or_fail()

# def test_tui_logger_pass_2():
#     logger = logging.getLogger("StandardPythonLogger")
#     title_logger = TitleLogger("TitleLogger")
#     content_begin_logger = ContentBeginLogger("ContentBeginLogger")
#     content_end_logger = ContentEndLogger("ContentEndLogger")
