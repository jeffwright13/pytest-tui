...
def test_nested_outer_function():
    ...
    logger.info(
        "This is just a regular log message in the middle of the nested outer function."
    )
    ...
    logger.warning(
        "This is just a regular log message at the end of the nested outer function."
    )
...
def nested_inner_function():
    ...
    logger.info(
        "This is just a regular log message at the end of the nested inner function."
    )
