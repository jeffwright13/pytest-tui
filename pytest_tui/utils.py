...
class TuiTestResults:
    ...
    def all_passes(self) -> List[TuiTestResult]:
        return [
            test_result
            for test_result in self.test_results
    ...
    def all_skipped(self) -> List[TuiTestResult]:
        return [
            test_result
            for test_result in self.test_results
    ...
    def all_xfails(self) -> List[TuiTestResult]:
        return [
            test_result
            for test_result in self.test_results
    ...
    def all_xpasses(self) -> List[TuiTestResult]:
        return [
            test_result
            for test_result in self.test_results
    ...
    def all_errors(self) -> List[TuiTestResult]:
        return [
            test_result
            for test_result in self.test_results
    ...
    def all_reruns(self) -> List[TuiTestResult]:
        return [
            test_result
            for test_result in self.test_results
...
def create_tui_files_directory():
    tui_files_dir = Path.cwd().resolve() / "tui_files"
    tui_files_dir.mkdir(exist_ok=True)
    return tui_files_dir
